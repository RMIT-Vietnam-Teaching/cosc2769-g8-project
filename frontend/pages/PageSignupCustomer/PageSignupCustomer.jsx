					...
					<div className='my-4 d-flex flex-column gap-4 p-4 rounded-2 shadow bg-body'>
						...
						<form id='form' className='d-flex flex-column gap-4' action={signUpAction}>
							<h4 className='px-3'>
								...
								<span className='text-primary ms-2'>Customer</span>
							</h4>
							...
							<div className='px-3'>
								...
								/>
								{isSigningUp || state.error.name == null ? null : (
									<ul className='ps-4 invalid-feedback m-0'>
										{(state.error.name ?? []).map((e, i) => (
											<li key={i}>{e}</li>
										))}
									</ul>
								)}
							...
							<div className='px-3'>
								...
								/>
								{isSigningUp || state.error.address == null ? null : (
									<ul className='ps-4 invalid-feedback m-0'>
										{(state.error.address ?? []).map((e, i) => (
											<li key={i}>{e}</li>
										))}
									</ul>
								)}
